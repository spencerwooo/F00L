...
pbar.write('Adversarials generated in: {:.2f}m {:.2f}s'.format(time_elapsed // 60, time_elapsed % 60))
...
pbar.write('Model predicted adversarials with an accuracy of: {:.2f}%'.format(adv_acc))
