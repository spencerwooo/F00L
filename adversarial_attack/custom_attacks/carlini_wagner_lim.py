...
# pylint: disable=protected-access, missing-class-docstring, arguments-differ, line-too-long
...
class LimitedCarliniWagnerL2Attack(Attack):
...
class AdamOptimizer:
  ...
  def __call__(
    self, gradient, learning_rate, beta1=0.9, beta2=0.999, epsilon=1e-8
  ):
